...
d1, d2 = get_gaussian_aperture(dim, mu, cov, hf_gaussian, dmin,
 join(vtk_dir, 'aperture.npz'))
...
mmdg2_dmean_notrafo = \
 MMDG2(dim, order, reduced_grid, problem_dmean, mu0, xi, contortion=False)
mmdg2_dmean_notrafo.solve(
 solver_mmdg, iter, tol, f_tol, eps, accelerate, verbose)
...
mmdg2_dmean_trafo = \
 MMDG2(dim, order, reduced_grid, problem_dmean, mu0, xi, contortion=True)
mmdg2_dmean_trafo.solve(
 solver_mmdg, iter, tol, f_tol, eps, accelerate, verbose)
